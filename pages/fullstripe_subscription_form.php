<form action="" method="POST" id="payment-form">
    ...
    <fieldset>
      ...
      <div class="row-fluid">
        ...
        <div class="control-group span6">
            <label class="control-label fullstripe-form-label"><?php _e("First name", "wp-full-stripe"); ?></label>
            <div class="controls">
        ...
        <!-- Last name -->
        <div class="control-group span6">
            <label class="control-label fullstripe-form-label"><?php _e("Last name", "wp-full-stripe"); ?></label>
            <div class="controls">
      ...
      <div class="row-fluid">
        ...
        <div id="doctype-selector" class="control-group span3">
            <label class="control-label fullstripe-form-label"><?php _e("Type of document", "wp-full-stripe"); ?></label>
            <label class="inline">
        ...
        <div id="doctype-values" class="control-group span3">
            <div data-type="dni">
              <label class="control-label fullstripe-form-label">DNI/NIE</label>
              <div class="controls">
                <input type="text" class="fullstripe-form-input" name="fullstripe_doc_dni" id="fullstripe_doc_dni">
              </div>
            </div>
            <div data-type="passport">
              <label class="control-label fullstripe-form-label"><?php _e("Passport", "wp-full-stripe"); ?></label>
              <div class="controls">
        ...
        <div class="control-group span4">
            <label class="control-label fullstripe-form-label"><?php _e("Date of birth", "wp-full-stripe"); ?></label>
            <div class="controls">
      ...
      <div class="row-fluid">
          <!-- Email -->
          <div class="control-group span6">
              <label class="control-label fullstripe-form-label"><?php _e("Email", "wp-full-stripe"); ?></label>
              <div class="controls">
          ...
          <!-- Email confirmation -->
          <div class="control-group span6">
              <label class="control-label fullstripe-form-label"><?php _e("Confirm email", "wp-full-stripe"); ?></label>
              <div class="controls">
      ...
      <div class="row-fluid">
        <div class="control-group span3">
            ...
            <div class="controls">
              <select name="fullstripe_address_country" id="fullstripe_address_country" readonly>
                <option value="ES"><?php _e("Spain", "wp-full-stripe"); ?></option>
              </select>
            </div>
        </div>
        <div class="control-group span3">
    ...
    <fieldset>
      ...
      <!-- Subscription Plan -->
      <div class="control-group">
          <label class="control-label fullstripe-form-label"><?php _e("Donation per month", "wp-full-stripe"); ?></label>
          <div class="controls">
    ...
    <div class="control-group">
      <div class="general-conditions-wrapper">
        ...
        <!--CONDICIONS GENERALS DE LES COL·LABORACIONS-->
        ...
        <!--CONDICIONES GENERALES COLABORACIONES-->
